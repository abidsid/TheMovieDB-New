...
public class NowPlaying extends Fragment {
  ...
  //  String api_key = "75d6a21a24cc88a4b60fcd0246f02ad1";
    String api_key = UpdateConfig.getConfigValue(configValues.context,"Key");
    Toolbar toolbar;
    TabLayout tabLayout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        call.enqueue(new Callback<MovieResponse>() {
            ...
            public void onResponse(Call<MovieResponse> call, Response<MovieResponse> response) {
                ...
                System.out.println("hello------"+movies.get(2).getOverview());
                System.out.println("-----------------------------");
                System.out.println("movies_genre--"+movies);
